...
static void print_report(int is_last_report, int64_t timer_start, int64_t cur_time)
{
    ...
    if (print_stats || is_last_report) {
        ...
        /// alimysoyang
        /// 获取转码的当前时间, buf.str
        //        bridge_setCurrentTime(buf.str);
        [FFmpegCmd.share getCurrentTime:buf.str];
        fflush(stderr);
    }
...
//        ffmpeg_var_cleanup();
        ...
        /// alimysoyang 添加结束时的状态， decode_error_stat[0]-frame状态，decode_error_stat[1]-error状态
